...
// Model tiers with colors (matching Claude models) - Chinese labels
const MODEL_TIERS: Record<string, { label: string; color: string; desc: string }> = {
  fast: { label: '快速', color: 'text-blue-500', desc: '快速响应，适合简单任务' },
  standard: { label: '标准', color: 'text-green-500', desc: '平衡性能与成本' },
  advanced: { label: '高级', color: 'text-purple-500', desc: '最强能力，复杂任务' },
};
...
export function ModelSwitcherDialog({ onClose }: ModelSwitcherDialogProps) {
  ...
  // Memoize filtered models to avoid recalculating on every render
  ...
  // Use shared focus trap hook with additional keyboard navigation
      ...
      <div className="bg-card border shadow-lg rounded-lg max-w-lg w-full max-h-[80vh] overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-b bg-muted/30">
          <div className="flex items-center justify-between">
            <h3 id="model-dialog-title" className="text-lg font-semibold flex items-center gap-2">
